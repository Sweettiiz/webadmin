  ...
  <VaCard class="flex flex-col">
    ...
    <VaCardContent class="flex flex-col-reverse md:flex-row md:items-center justify-between gap-5 h-full">
      <section class="flex flex-col items-start w-full sm:w-1/3 md:w-2/5 lg:w-1/4 gap-2 md:gap-8 pl-4">
        <div>
          <p class="text-xl font-semibold">10000/100000</p>
      ...
      <RevenueReportChart
        class="w-2/3 md:w-3/5 lg:w-3/4 h-full min-h-72 sm:min-h-41 pt-4"
        :revenues="revenues"
        :months="months"
      />
    </VaCardContent>
...
import RevenueReportChart from '../company-token/RevenueReportChart.vue'
import {
  // earningsColor,
  // expensesColor,
  months,
  generateRevenues,
  // getRevenuePerMonth,
} from '../company-token/revenueChartData'
