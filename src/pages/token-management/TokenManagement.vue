...
import { useModal, useToast, VaTextarea } from 'vuestic-ui'
...
<template>
  ...
  <VaCard>
    <VaCardContent>
      <div class="flex flex-col md:flex-row gap-2 mb-2 justify-between">
        ...
        <div class="flex flex-col md:w-1/2">
          <span class="flex mb-2">ติดต่อสำหรับการเพิ่มโทนเคน</span>
          <div class="flex flex-col">
            <VaTextarea class="flex w-full h-[4rem]" placeholder="Message"></VaTextarea>
            <div>
              <VaButton class="flex mt-2">Submit</VaButton>
            </div>
          </div>
        </div>
      </div>
    ...
    >
      <h1 v-if="projectToEdit === null" class="va-h5 mb-4">Add User</h1>
      <h1 v-else class="va-h5 mb-4">Edit Token</h1>
      <EditProjectForm
        ref="editFormRef"
