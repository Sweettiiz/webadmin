...
const { projects, update, add, isLoading } = useProjects()
...
<template>
  <h1 class="page-title">Edit Company Token</h1>
  ...
  <VaCard>
    <VaCardContent>
      ...
      <ProjectCards v-if="doShowAsCards" :projects="projects" :loading="isLoading" @edit="editProject" />
    </VaCardContent>
